...
class PagesController extends AppController {
    ...
    public function loadPages($slug = null) {
        $pagetable = $this->loadModel('Pages');
        // $pagetable = TableRegistry::get('Pages');
        $pages = $pagetable->find('all', array('conditions' => array('slug' => strval($slug))));
        $page = $pages->first();
