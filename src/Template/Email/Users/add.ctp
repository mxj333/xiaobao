<div class="col-md-6">
    <form class="form-horizontal" action="javascript:void(0);" method="POST" id="register">
      <fieldset>
        <div id="legend">
          <legend class=""><?= __('Register')?></legend>
        </div>
        <div class="control-group">
            <label class="control-label" for="username"><?= __('Mobile phone')?></label>
            <div class="controls">
                <input type="text" id="username" name="username" value="" placeholder="Mobile phone" class="form-control input-lg" autocomplete="off" required="" title="<?= __('Please provide your Mobile phone')?>">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="password" id="password" name="password" value=""  placeholder="<?= __('Password')?>" class="form-control input-lg">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="password" id="password_confirm" name="password_confirm" placeholder="<?= __('Password (Confirm)')?>" class="form-control input-lg">
                <p class="help-block"></p>
            </div>
        </div>
        <!-- <div class="control-group">
        ...
        <div class="control-group">
            <div class="controls">
                <button class="btn btn-success register"><?= __('Register')?></button>
...
<script>
    $(function(){
        ...
        $(".register").bind("click", function(event) {
            ...
            $.post('/ucenter/users/register', pram, function(json){
                console.log(json);
                if (json.status == 1) {
