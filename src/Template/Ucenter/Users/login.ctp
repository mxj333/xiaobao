        ...
        <div class="modal-dialog">
            ...
            <?= $this->Form->create() ?>
                ...
                <div class="modal-body">
                    <form class="form col-md-12 center-block">
                        <div class="form-group">
                            <input type="text" name="username" class="form-control input-lg" placeholder="请输入手机号\用户名">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <button class="btn btn-primary btn-lg btn-block"><?= __('登录')?></button>
                ...
                <div class="modal-footer">
                    <div class="col-md-12">
                        <span  class="pull-left"><a href="/" class="btn btn-default"><?= __('返回首页')?></a></span>
                        <span class="pull-right"><a href="/users/register" class="btn btn-default"><?= __('注册新账号')?></a></span>
                        <span class="pull-right"><a href="javascript:void(0);" class="btn ">忘记密码</a></span>
                    </div>
                </div>
            <?= $this->Form->end() ?>
            </div>
