...
webStorage.webSql = function() {
    ...
    this.createTable = function () {
        ...
        dataBase.transaction(function (tx) {
            tx.executeSql(
        "create table if not exists subjects (id int(10) PRIMARY KEY, s_id int, type int, title varchar(255), body varchar(500), answer varchar(10), done varchar(10))",
        [],
    ...
    this.save = function (data) {
        ...
        dataBase.transaction(function (tx) {
            tx.executeSql(
                "INSERT INTO subjects (id, subject_id,type, title, body, answer, done) VALUES (?, ?, ?, ?, ?, ?, ?)"
                [1, 1, 1, 'aa', 'bb', 'a', 'a'],
                function() {
                    alert('添加数据成功');
                },
